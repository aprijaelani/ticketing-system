  ...
  <div class="col-md-12">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">                                
        <h3 class="panel-title">List Data Services Schedule</h3>
        ...
        <table class="table datatable">
          ...
          <tbody>
            ...
            <td>{{$engineer_service->description}}</td>
             @if($engineer_service->status == 2)
              <td>{{'Scheduled'}}</td>
              @endif
            <td>{{$engineer_service->user['name']}}</td>
            <td>
              <a href="schedule/{{ $engineer_service->id }}/edit" class="btn btn-primary btn-sm">Edit Engineer</a>
              <a href="{{ $engineer_service->id }}/print-work-order" target="_blank" class="btn btn-danger btn-sm">Print Work Order</a>
            </td>
            </tr>
            @endforeach
          </tbody>
