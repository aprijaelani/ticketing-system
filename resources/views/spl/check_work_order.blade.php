...
<div class="row">
	<div class="col-md-12">
		...
		<form class="form-horizontal" method="post" action="test" enctype="multipart/form-data">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"><strong>Work Order</strong> Check</h3>
					<ul class="panel-controls">
						<li><a href="#" class="panel-remove"><span class="fa fa-times"></span></a></li>
					</ul>
				</div>
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-md-3">                                            
									<div class="input-group">
										<label class="col-md- control-label">{{$engineer_services->work_order['supply_thermal']}} <strong>&nbsp;Roll</strong></label>
									</div>                         
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-3">                                            
									<div class="input-group">
										<label class="col-md- control-label">{{$engineer_services->work_order['respon_time_debit']}} <strong>&nbsp;Detik</strong></label>
									</div>                         
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-3">                                            
									<div class="input-group">
										<label class="col-md- control-label">{{$engineer_services->work_order['respon_time_kredit']}} <strong>&nbsp;Detik</strong></label>
									</div>                           
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-3">                                            
									<div class="input-group">
										<label class="col-md- control-label">{{$engineer_services->work_order['respon_time_prepaid']}} <strong>&nbsp;Detik</strong></label>
									</div>                          
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-3">                                            
									<div class="input-group">
										<label class="col-md- control-label">{{$engineer_services->work_order['respon_time_loyalty']}} <strong>&nbsp;Detik</strong></label>
									</div>                            
								</div>
							</div>
							...
							<div class="form-group" id="mobile_operators">
								<label class="col-md-3 control-label">Moblie Operator</label>
								<div class="col-md-3">
									<div class="input-group">
										@if($engineer_services->work_order['mobile_operator'] == null)
							...
							<div class="form-group" id="direct-line">
								<label class="col-md-3 control-label">Nomer Direct Line </label>
								<div class="col-md-5">                                            
									<div class="input-group">
										@if($engineer_services->work_order['nomor_direct_line'] == null)
										<label class="col-md- control-label">-</label>
										@else
										<label class="col-md- control-label">{{$engineer_services->work_order['nomor_direct_line']}}</label>
										@endif
									</div>                         
								</div>
							</div>
						...
						<div class="col-md-6">
							...
							<div class="form-group">               
								...
								<div class="col-md-3">
									<div class="input-group">
										<label class="col-md- control-label" style="text-align: left;">{{$engineer_services->work_order['jam_selesai']}}</label>           
									</div>
								</div>
							</div>
