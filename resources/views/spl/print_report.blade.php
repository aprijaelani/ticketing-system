            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title" style="margin-left: 20px;"><strong>Report Services PT. Visionet Data International Service Point {{$service_points->nama}} on {{$mulai}} - {{$selesai}}</strong></h3>
                    </div>
